...
public class NewMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Global.getDisney().getEnsambladores().getSize());
        
        //Creamos y cargamos los PM de ambas empresas
        ProjectManager pm = new ProjectManager(6,240,mutexDisney,       Global.getDisney());
        ProjectManager pm2 = new ProjectManager(6,240,mutexDisney,Global.getCartoonNetwork());
        pm.start();
        pm2.start();
